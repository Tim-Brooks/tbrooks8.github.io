...
4. Optional Latency Metrics - latency metrics for the different execution results.
...
This interface merely indicates is that the implementing class has a GuardRail. The actual acquiring and releasing of permits and execution must be implemented.
...
1. A [LoadBalancer](https://github.com/tbrooks8/Precipice/blob/master/precipice-core/src/main/java/net/uncontended/precipice/pattern/RoundRobinLoadBalancer.java) - this balances acquire calls to different Precipices. It defines a acquireCount() of one.
